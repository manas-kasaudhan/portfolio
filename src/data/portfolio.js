...
export const personal = {
  ...
  location: 'India',
  resumePath: '/resume/Manas_Kasaudhan_Resume.pdf',
...
export const projects = [
  {
    ...
    live: 'https://anatomy-master.netlify.app',
  ...
  },
  {
    ...
    title: 'Loco Weather',
    description:
      'A real-time weather application with location-based forecasting, 7-day predictions, and rich weather condition visualizations.',
    ...
    live: 'https://loco-weather.netlify.app',
  ...
  },
  {
    ...
    title: 'Resuscan',
    description:
      'An advanced AI-powered platform for scanning and analyzing data with cutting-edge artificial intelligence models.',
    techStack: ['React.js', 'Node.js', 'AI', 'Tailwind CSS'],
    features: [
      'AI-powered scanning',
    ...
    github: 'https://github.com/manas-kasaudhan/resuscan',
    live: 'https://resuscan-ai.netlify.app',
